...
export function ThemedText({variant,color,...rest}:Props) {
    return <Text style={styles[variant ?? 'body3']} {...rest}></Text>; // variant ?? 'body3' it means if the the variant value is null or undefined the defaut value  of variant will be 'body3'
}
